...
set -gx VIRTUAL_ENV /Users/sofia/PycharmProjects/InternetMagazine/.venv
...
if test -n internetmagazine-py3.12
    set -gx VIRTUAL_ENV_PROMPT internetmagazine-py3.12
else
